  ...
  return (
    <HeroParallax>
      <section
        ...
        data-parallax-shell
        className="origin-center grid items-center gap-10 will-change-transform lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-0"
      >
        <div className="flex min-w-0 flex-col gap-6 text-center lg:gap-7 lg:text-left">
          <div data-parallax="copy" className="flex flex-col gap-6 will-change-transform lg:gap-7">
